...
const VehicleDetailsPage = () => (
  <div className="min-h-screen bg-gray-50 px-4 py-10 text-gray-900">
    <div className="mx-auto max-w-4xl">
      <p className="text-sm font-semibold text-orange-500">Vehicle details</p>
      <h1 className="text-3xl font-bold">Check vehicle details</h1>
      <p className="mt-2 text-sm text-gray-600">Verify RC, insurance, and compliance details before you buy.</p>

      <div className="mt-6 rounded-lg border border-gray-200 bg-white p-4 shadow-sm">
        <ul className="list-disc space-y-2 pl-5 text-sm text-gray-700">
          <li>Registration and chassis details</li>
          <li>Insurance validity and claim history</li>
          <li>PUC and roadworthiness checks</li>
        </ul>
      </div>
